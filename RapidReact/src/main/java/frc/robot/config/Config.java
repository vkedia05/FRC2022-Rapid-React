...
public class Config {
  ...
  public Config() {
    ...
    shooter.shooterTop.velocityPIDF = new PIDF(/*P*/0.0001, /*I*/0.000 / 1000, /*D*/0,/*F*/0, /*izone*/300);
    shooter.shooterTop.inverted = true;

    shooter.shooterBottom.id = shooterBottom_ID;
    shooter.shooterBottom.velocityPIDF = new PIDF(/*P*/0.0001, /*I*/0.000 / 1000, /*D*/0, /*F*/0, /*izone*/300);
